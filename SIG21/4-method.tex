...
For example, in \Cref{eqn:emc2} I define all symbols inside \filename{TOG\\symbols.tex} so later if I need to change $\energy$ from $E$ to $e$ I just need to change one line in \filename{TOG\\symbols.tex} instead of chasing $E$ everywhere.
This can save you a lot of time and sanity if you have many math symbols.

\subsection{Code}
\label{sec:code}

\input{TOG/dart_throw_alg}
