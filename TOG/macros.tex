...
\definecolor{nyuColor}{rgb}{0.34,0.18,0.55} % R87, G46, B140
\newcommand{\zh}[1]{{\color{nyuColor} Zhenyi: #1 $\qed$}}
\definecolor{sjtuColor}{rgb}{0.31,0.65,0}
\newcommand{\dnc}[1]{{\color{sjtuColor} Nianchen: #1 $\qed$}}
\newcommand{\dncR}[1]{{\color{sjtuColor} #1 $_{\mathrm{Nianchen}}$}}
\newcommand{\zhtd}[1]{{\color{nyuColor} #1 }}
...
\newcommand{\praneeth}[1]{{\color{GuardianColor} Praneeth: #1 $\qed$}}
